      ...
      <Fragment> 
        <div className="page-top">
          <div className="header-top">
            <div className="header-top-left">
              ...
              <span className="header-top-left-number">+7 (812) 613-58-38</span>
              <span className="header-top-left-work-days">Пн–пт 10:00–19:00, сб-вс 10:00–17:00</span>
            </div>
            <div className="header-top-right">
              <span className='header-top-wright-us'>Напишите нам</span>
              <span className='connect-with-director'>Свяжитесь с директором</span>
          ...
          <header className='page-header'>
            <div className="header-elems">
              ...
              <div className="search-block">
                ...
                <SearchIcon className='mobile-menu-search-btn'/>
              ...
              <a href="#" className='log-in-link'>
                ...
                <span className='log-in-btn'>Войти</span>
              </a>
              <a href="#" className="cart-btn">
                <img className='cart-icon' src={cartIcon} alt="cartIcon"/>
                <span className='cart-text'>Корзина пуста</span>
              </a>
            </div>
            <nav className='menu-list-block'>
              <label className='tablet-menu-label' htmlFor="tablet-menu-check">
                <MenuIcon/>
              </label>
              <input type="checkbox" name="" id="tablet-menu-check"/>
              <ul  className="nav">
                <a href="#" className='mobile-log-in-link'>
                  <img className='mobile-log-in-icon' src={logInIcon} alt="loginIcon"/>
                  <span className='log-in-btn'>Войти</span>
                </a>
                <li className='nav-list-item'><a className='nav-item' href="#">Акции</a></li>
                <li className='nav-list-item'><a className='nav-item' href="#">О нас</a></li>
                <li className='nav-list-item'><a className='nav-item' href="#">Мероприятия</a></li>
                <li className='nav-list-item'><a className='nav-item' href="#">Оплата и доставка</a></li>
                <li className='nav-list-item'><a className='nav-item' href="#">Что с моим заказом?</a></li>
                <li className='nav-list-item'><a className='nav-item' href="#">Гос. закупки</a></li>
                <li className='nav-list-item'><a className='nav-item' href="#">Блог</a></li>
                <li className='nav-list-item'><a className='nav-item' href="#">Мастер-классы</a></li>
                <li className='nav-list-item'><a className='nav-item' href="#">Контакты</a></li>
              </ul>
            </nav>
          </header>
          <hr/>
          <div className="services-block">
            <label className='tablet-services-block' htmlFor="tablet-services-check">
              <MenuIcon/>
            </label>
            <input type="checkbox" name="" id="tablet-services-check"/>
            <ul className="services">
              <li className='services-item-wrapper'><select className='services-item' name="printer" id="">
                <option value="3D-принтеры">3D-принтеры</option>
                <option value="Тип 1">Тип 1</option>
                <option value="Тип 1">Тип 2</option>
              </select></li>
              <li className='services-item-wrapper'><select className='services-item' name="scaner" id="">
                <option value="3D-сканеры">3D-сканеры</option>
                <option value="Тип 1">Тип 1</option>
                <option value="Тип 1">Тип 2</option>
              </select></li>
              <li className='services-item-wrapper'><select className='services-item' name="Machine tools" id="">
                <option value="Станки">Станки</option>
                <option value="Тип 1">Тип 1</option>
                <option value="Тип 1">Тип 2</option>
              </select></li>
              <li className='services-item-wrapper'><select className='services-item' name="robots" id="">
                <option value="Роботы">Роботы</option>
                <option value="Тип 1">Тип 1</option>
                <option value="Тип 1">Тип 2</option>
              </select></li>
              <li className='services-item-wrapper'><select className='services-item' name="education" id="">
                <option value="Образование">Образование</option>
                <option value="Тип 1">Тип 1</option>
                <option value="Тип 1">Тип 2</option>
              </select></li>
              <li className='services-item-wrapper'><select className='services-item' name="dantists" id="">
                <option value="Стоматологам">Стоматологам</option>
                <option value="Тип 1">Тип 1</option>
                <option value="Тип 1">Тип 2</option>
              </select></li>
              <li className='services-item-wrapper'><select className='services-item' name="gadjets" id="">
                <option value="Гаджеты">Гаджеты</option>
                <option value="Тип 1">Тип 1</option>
                <option value="Тип 1">Тип 2</option>
              </select></li>
              <li className='services-item-wrapper'><select className='services-item' name="materials" id="">
                <option value="Материалы">Материалы</option>
                <option value="Тип 1">Тип 1</option>
                <option value="Тип 1">Тип 2</option>
              </select></li>
              <li className='services-item-wrapper'><select className='services-item' name="software" id="">
                <option value="ПО">ПО</option>
                <option value="Тип 1">Тип 1</option>
                <option value="Тип 1">Тип 2</option>
              </select></li>
              <li className='services-item-wrapper'><select className='services-item' name="solutions" id="">
                <option value="Решения">Решения</option>
                <option value="Тип 1">Тип 1</option>
                <option value="Тип 1">Тип 2</option>
              </select></li>
              <li className='services-item-wrapper'><select className='services-item' name="study-center" id="">
                <option value="Учебный центр">Учебный центр</option>
                <option value="Тип 1">Тип 1</option>
                <option value="Тип 1">Тип 2</option>
              </select></li>
              <li className='services-item-wrapper'><select className='services-item' name="services" id="">
        ...
        <main className="services-description">
          ...
          <ul className="about-company-links">
            <li className='about-company-links-item'>
              <a className='about-company-link' href="#">
                ...
                <svg className='about-company-link-arrow' width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M0.999999 9L5 5L1 1" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </a>
            </li>
            <li className='about-company-links-item'>
          ...
          <div className="footer-head">
            ...
            <div className='footer-head-btns'>
              <button className='footer-head-btn'>
                <svg className='footer-arrow' viewBox="0 0 11 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M10 1L1 9.5L10 18" stroke="#4D4D4D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </button>
              <button className='footer-head-btn'>
                <svg className='footer-arrow' viewBox="0 0 11 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M0.999998 18L10 9.5L0.999999 0.999999" stroke="#4D4D4D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </button>
            </div>
          </div>
